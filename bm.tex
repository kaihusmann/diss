...
%\vspace{0.5cm}
\noindent
$^2$Northwest German Forest Research Institute, Department of Forest Growth, Section of Forest Growth Modeling and Computer Science,\\ Grätzelstraße 2, 37079 Göttingen, Germany\\
...
\begin{itemize}
	...
	\item Jürgen Nagel supported writing of the manuscript and the review process.
\end{itemize}
...
The authors are grateful to the Project Management Jülich of the Federal Ministry of Education and Research for funding this research through the projects \textit{BEST} (003L033F) and Cluster \textit{Bio-Economy} (031A294) as well as to the Agency for Renewable Resources of the Federal Ministry for Consumer Protection, Food and Agriculture for funding the project \textit{Möglichkeiten und Grenzen der Vollbaumnutzung} (22015407). We would like to thank the anonymous reviewers for their helpful and constructive revision of the manuscript.
