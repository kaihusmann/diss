...
\textsc{\begin{figure}[h]
		...
		\caption{Simulated yield of the three different scenarios in 5-year periods, beginning with the period from 2011 to 2016. The yield is differentiated in coniferous and deciduous wood volume as well as in thinning and target usage. The goal diameters for the target usages are given in Table \ref{tab:discussion:struct:opt:application:tab1}}
