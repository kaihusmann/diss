...
\begin{table}[ht]
	\centering
		\caption{Overview of the three scenarios which were developed for sensitivity analysis of the simulation-simulation software.}
		\label{tab:discussion:struct:opt:application:scenarios}
		\begin{tabular}{ccc}
			\hline
			scenario & treatment & restictions \\ 
			\hline
			1 & \begin{tabular}{c}standard treatment,\\determined \end{tabular} & no restrictions \\ 
