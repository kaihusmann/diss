...
\newpage
\begin{itemize}
	\item Bernhard Möhring supported analysis of the results, writing of the manuscript and the review process.
\end{itemize}
...
\begin{figure}
	\center
	\includegraphics[width=0.49\textwidth]{Grafiken/beech_crowns/Fig_4_marginal_return.eps}
